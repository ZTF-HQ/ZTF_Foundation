...
<div class="container">
    ...
    <form id="registrationForm" class="space-y-8" method="POST" action="{{ route('staff.form.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-step">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input type="tel" name="phoneNumber" placeholder="Phone No." class="input">
        ...
        <div class="flex justify-between mt-8">
            ...
            <button type="button" id="submitBtn" class="bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700 transition" style="display:none;">Finish & Download PDF</button>        </div>
    </form>
</div>
